    ...
    render() {
        return (
            <Row>
                ...
                <Col className="col-1-5 px-0 my-auto text-left">{this.props.position}</Col>
                <Col className="col-1 px-0 my-auto text-left">{this.YearMap.get(this.props.year as string)}</Col>

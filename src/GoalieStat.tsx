    ...
    render() {
        return (
            <Row>
                ...
                <Col className="col-1 my-auto px-0 text-right">{this.props.Saves}</Col>
                <Col className="col-1-5 my-auto px-0 text-right">{formatPercentage(this.props.Percentage)}</Col>
            </Row>
        );
    }
}